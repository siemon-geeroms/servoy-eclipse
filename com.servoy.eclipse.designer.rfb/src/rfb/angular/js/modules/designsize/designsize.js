angular.module('designsize', [ 'toolbar', 'editor' ]).factory("$designsize", function($rootScope, $toolbar, TOOLBAR_CATEGORIES, $pluginRegistry) {
    return {
	load : function() {
	    var btnDesktopSize = {
		text : "Desktop",
